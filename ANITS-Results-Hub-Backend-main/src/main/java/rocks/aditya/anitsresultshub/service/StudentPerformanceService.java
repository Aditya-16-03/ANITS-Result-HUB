...
public class StudentPerformanceService {
    ...
    public void savePerformance(String batch,
        ...
        // ðŸ” FIX ZIP BOMB ISSUE (safe for admin uploads)
        ...
        try (InputStream is = file.getInputStream();
            ...
            log.info("ðŸ“Š Normalized columns: {}", columns);
            ...
            log.info("âœ… Inserted {} rows into {}", batchArgs.size(), tableName);
        }
    }
